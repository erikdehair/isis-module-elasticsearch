...
public class SearchServiceHidden extends ElasticSearchService {
    private static final Logger log = LoggerFactory.getLogger(SearchServiceHidden.class);
    ...
    public SortedSet<SearchResult> executeFind(String query, Class<Indexable> preferredType) {
        ...
        if (isPreferationSet) {
            ...
            builder = builder.setQuery(QueryBuilders.functionScoreQuery(generalQueryBuilder, functions));
        } else {
