 ...
 *  under the License.
 */
package org.isisaddons.module.elasticsearch.webapp;
 ...
 * 
 */
public class ElasticSearchModuleApplication extends IsisWicketApplication {
    ...
    private static final String APP_NAME = "ElasticSearch Module Example App";
    ...
    protected Module newIsisWicketModule() {
        ...
        final Module overrides = new AbstractModule() {
            ...
            protected void configure() {
                ...
                // bind(AppManifest.class).toInstance(new ElasticSearchAppAppManifest());
            }
        };
